...
function Header() {
  return (
    <div className="bg-primary-color sticky top-0 z-50">
      <div className="container mx-auto h-16 sm:h-11 flex items-center ml-4 justify-center sm:justify-around">
        <a href="/">
          <img
        ...
        <div></div>
        <div className="flex gap-x-8 hidden md:flex lg:flex xl:flex 2xl:flex">
          <a
            href="/"
            className="flex gap-x-2 text-white text-opacity-90 hover:text-opacity-100 transition-all"
          >
            <FiGlobe size={22} />
            Türkçe(TR)
          </a>
